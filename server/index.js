...
//       res.json({bookings: allBooking.rows})
...
// //     try {
// //       const updateBooking = await pool.connect();
  
// //       // Use a SQL UPDATE statement to update the record
// //       const query = 'UPDATE Booking SET status = $1 WHERE bookingid = $2 *';
// //       const values = [status, bookingID];
  
// //       const result = await updateBooking.query(query, values);
  
// //       // Release the client back to the pool
// //       updateBooking.release();
