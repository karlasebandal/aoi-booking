...
const NavBar = () => {
  return (
    <div>
      <nav class="bg-marble-blue fixed w-full z-20 top-0 left-0">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                    <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-marble-blue md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-marble-blue dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <Link to="/about" class="block py-2 pl-3 pr-4 text-purity font-header bg-rescue-orange rounded md:bg-transparent md:text-rescue-orange md:p-0 md:dark:text-rescue-orange" aria-current="page">ABOUT</Link>
                        </li>
                        <li>
                            <Link to="/services" class="block py-2 pl-3 pr-4 text-purity font-header rounded hover:bg-navy-blue md:hover:bg-transparent md:hover:text-navy-blue md:p-0 md:dark:hover:text-rescue-orange dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">SERVICES</Link>
                        </li>
                        <li>
                            <Link to="/contact" class="block py-2 pl-3 pr-4 text-purity font-header rounded hover:bg-navy-blue md:hover:bg-transparent md:hover:text-navy-blue md:p-0 md:dark:hover:text-rescue-orange dark:text-white dark:hover:bg-gray-700 dark:hover:text-rescue-orange md:dark:hover:bg-transparent dark:border-gray-700">CONTACT
                            </Link>
                        </li>
                    </ul>
                </div>
